...
public class PageParserTest {
    ...
    private static List<PageSection> buildPageSections() {
        ...
        sections.add(new PageSection("Presidential Standard", " The Standard of the President of Kazakhstan is similar to the national flag in that it is rectangular in shape with a ratio of 1:2. In the center of the standard is the Emblem of Kazakhstan. It is bordered on three sides with golden fringe.[3][4]  Presidential Standard (1995—2012)  The current presidential standard has been in service as recently as 2012. The former standard, which was used from 1995–2012, was a light blue rectangle there with a golden circle in which the figure of the young Kazakh leader Sakas riding a snow leopard. "));
        sections.add(new PageSection("Altyn Qyran Order", " The Order of the Golden Eagle (Kazakh: Алтын Қыран ордені or Altyn Qyran Order) is the highest civilian award that can be awarded by the President of Kazakhstan. Its purpose is to recognize outstanding service to the country by Kazakh and foreign citizens. As head of state, the President is de facto Commander special class of the Order of Altyn Kyran.[5][6] "));
        sections.add(new PageSection("President in the Constitution", " Item 5 of Article 42 of the Constitution determines that no one can be elected president more than two terms in a row, but it also states that \"The present restriction shall not extend on the First President of the Republic of Kazakhstan.\" [7]  Article 46 says that the President's \"honor and dignity shall be inviolable\" and that his expenses shall be paid by the state. Item 4 of the article outlines the special status and authority of the first president, and refers to a special constitutional act for definitions.[7]According to this act, the first president possesses total, absolute and termless immunity for all actions he performs while in office, and that he remains a government official until his death. He also retains the ability to speak to the people of Kazakhstan, keeps guards, communication, transport, and state support of his activity, and that his official apartment and summer residence became his property with official maintenance. He is also provided with medical care, sanatorium, pensions and insurance.  On April 26, 2015 Nursultan Nazarbayev was re-elected for his 5th presidential term.[8] The official ceremony of the inauguration took place at the Palace of Independence in Astana on April 29.[8] At the inauguration ceremony the re-elected president assured the nation that he would continue the 5 institutional reforms that he had offered earlier, which would contribute to the consistent growth and development of the country.[8]  On January 25, 2017 President Nursultan Nazarbayev laid the groundwork for reforms to the constitution that would redistribute executive powers to the parliament and ministries for the purpose of more open and efficient governance.[9] "));
        sections.add(new PageSection("Presidential Administration", " The Presidential Administration of the Republic of Kazakhstan (Kazakh: Қазақстан Республикасы Президентінің Әкімшілігі/Russian: Администрация Президента Республики Казахстан) reports directly to the president and aids him/her in their everyday dates. It was established in accordance of Presidential Decree No. 2565 on October 20, 1995. It is currently based at the Ak-Orda Presidential Palace in the capital city of Astana. Prior to that, it was based in Almaty.[10] "));
        ...
        sections.add(new PageSection("Latest election", " Main article: Kazakhstani presidential election, 2015  Prior to the 2011 election, President Nazarbayev wrote an op-ed for the Washington Post titled \"Kazakhstan’s steady progress toward democracy\".[11]  Kazakhstan's fifth presidential election was held on April 26, 2015.[12] Nursultan Nazarbayev was re-elected with 97.7% of the vote.[13] A total of 858 observers from 19 countries were present at the polling stations during the election.[13]  The Organization for Security and Co-operation in Europe (OSCE) and other international monitors criticised the election as unfair, with issues noted including the closure of media outlets critical of the government and the jailing of opposition activists.[14] OSCE spokesperson Cornelia Jonker criticised the lack of a \"genuine choice\" for voters and also argued that there were \"significant restrictions to the freedom of expression.\"[15] "));
        sections.add(new PageSection("Presidents of Kazakhstan (1990–present)", " Main article: List of leaders of Kazakhstan  The \"No.\" column consecutively numbers the individuals who have served as president, while the \"Elected\" column consecutively numbers the Presidential terms or administrations.  More information: Political party, No. …  No.  Name  Portrait  Elected  Term of office  Political party   #D50000;\"}]]}\">1  Nursultan Nazarbayev Нұрсұлтан Назарбаев (1940–)   #D50000;\"}]]}\">—  24 April 1990  1 December 1991  Communist Party of Kazakhstan   #D50000;\"}]]}\">1 1991  1 December 1991  14 December 1991   (1)  14 December 1991  20 January 1999  Independent   2 1999  20 January 1999  1 March 1999   (1)  1 March 1999  11 January 2006  Otan   3 2005  11 January 2006  1 December 2006   (1)  1 December 2006  8 April 2011  Nur Otan   4 2011  8 April 2011  29 April 2015   5 2015  29 April 2015  20 March 2019[16] (resigned from office)   2  Kassym-Jomart Tokayev Қасым-Жомарт Тоқаев (1953–)   20 March 2019[17]  Incumbent  Nur Otan   Close "));
        sections.add(new PageSection("Rank by time in office", " More information: Rank, Time in office …   Rank  President  Time in office   1  Nursultan Nazarbayev  27 years, 94 days[18]   2  Kassym-Jomart Tokayev  13 days  Close "));
    ...
    @Test
    public void canExtractHTMLFromWebView() {
        ...
        PageParser.getPageHTML(webView, (html) -> {
