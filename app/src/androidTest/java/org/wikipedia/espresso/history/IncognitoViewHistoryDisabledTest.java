...
public class IncognitoViewHistoryDisabledTest {
    ...
    private void openAndCloseAndroidPage() {
    ...
    private void checkAndAssertNoEntries() {
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.history_empty_title), withText("No recently viewed articles"),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textView.check(matches(withText("No recently viewed articles")));
    }

    @Test
    public void icognitoViewHistoryTest() {

        goToSettingsPage();

        activateIncognito();

        openAndCloseAndroidPage();

        checkAndAssertNoEntries();
